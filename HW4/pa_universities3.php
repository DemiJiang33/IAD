<?php
    ...
    if ($option == 1){
          ...
          $query = "select * from pa_universities where institution_name like '%$aname%'";
          $result = executeSQL($query, $aname);
    ...
    if ($option == 2){
          ...
          $query = "select * from pa_universities where address like '%$aaddress%'";
          $result = executeSQL($query, $aaddress);
